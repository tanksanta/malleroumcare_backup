			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<input type="text" name="iq_email" value="<?php echo get_text($qa['iq_email']); ?>" class="form-control input-sm <?php echo !$member['mb_id'] ? 'required' : ''; ?>" size="30" <?php echo !$member['mb_id'] ? 'required' : ''; ?>>
					</div>
				</div>
				<div class="col-sm-6">
					<label for="iq_hp"><b class="en">휴대폰</b></label>
					<input type="text" name="iq_hp" value="<?php echo get_text($qa['iq_hp']); ?>" class="form-control input-sm <?php echo !$member['mb_id'] ? 'required' : ''; ?>" size="20" <?php echo !$member['mb_id'] ? 'required' : ''; ?>>
				</div>
			</div>
			<div class="form-group">
