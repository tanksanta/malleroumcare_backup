...
<div class="right_menu_area <?php echo $_COOKIE['right_menu_area'] == 'on' ? 'on' : ''; ?> ">
	...
	<div class="info">
		<p>CS CENTER</p>
		<p>T. <?php echo $default['de_admin_company_tel']; ?><br>
...
예금주 - 삼화에스앤디(주)고양지점
	...
	<div class="info">
		<p>Email / Web hard</p>
		<p>sales@shsnd.com<br>ID: shboard  / PW: 2070
		</p>
	</div>
	<div class="talk_area">
		<a href="#"> <img src="<?php echo THEMA_URL; ?>/assets/img/icon_talk_naver.png" alt=""> 네이버 톡톡 상담</a>
		<a href="#"> <img src="<?php echo THEMA_URL; ?>/assets/img/icon_talk_kakao.png" alt=""> 카카오톡 상담</a>
	</div>
	<div class="sns_link">
		<a href="#"> <img src="<?php echo THEMA_URL; ?>/assets/img/btn_sns_blog.png" alt=""></a>
		<a href="#"> <img src="<?php echo THEMA_URL; ?>/assets/img/btn_sns_instar.png" alt=""></a>
		<a href="#"> <img src="<?php echo THEMA_URL; ?>/assets/img/btn_sns_you.png" alt=""></a>
	</div>
</div>
...
<div id="thema_wrapper" class="wrapper <?php echo $is_thema_layout;?> <?php echo $is_thema_font;?>">
	...
	<div id="wrap">
		...
		<div class="container_wrap txt_center top_common_area">
			...
			<div class="top_right_area">
				<div class="link_area">
					...
					<?php }else{ ?>
						<a href="<?php echo $at_href['login'];?>">로그인</a>
		...
		<div class="top_menu_wrap">
			<div class="menu_wrap">
				<div class="menu"><button class="top_menu_all"><img src="<?php echo THEMA_URL; ?>/assets/img//btn_top_menu.png" ></button></div>
				<div class="main_menu">
					<table >
						<tr>
				...
				<div class="all_menu">
					<table>
						<?php for($i=0;$i<count($category);$i++) { ?>
							<?php if ( $i == 0 ) echo '<tr>'; ?>
							<td>
								<div class="tit"><?php echo $category[$i]['ca_name']; ?></div>
		...
		// 배너
		$bn_md = array();
		$tb_result = sql_query("SELECT * FROM g5_shop_banner WHERE bn_device = 'both' AND ('" .G5_TIME_YMDHIS . "' between bn_begin_time and bn_end_time" . ") AND bn_position = '메인대형배너' ORDER BY bn_order ASC ");
		while($tb_row = sql_fetch_array($tb_result)) {
			$bn_md[] = $tb_row;
		}
