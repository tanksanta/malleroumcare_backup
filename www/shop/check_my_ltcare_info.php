...
<script>
	swal({
		title : "사용 제한",
		text : "수급자 조회조건 개선으로 간편조회 및\n일부 서비스가 일시 중단되었습니다.\n서비스 재개는 추후 공지를 통해 안내드리겠습니다.",
    	type  : "error",
    	closeOnClickOutside : false
	}, function(){
		history.back();
	});
	//swal("사용 제한","수급자 조회조건 개선으로 간편조회 및 일부 서비스가\n일시 중단되었습니다.\n서비스 재개는 추후 공지를 통해 안내드리겠습니다.","error")){
	//	history.back();
...
<script type="text/javascript">
	$( document ).ready(function() {
		...
		//캘린더
		$('#penBirth').datepicker({ changeMonth: true, changeYear: true, dateFormat: 'yymmdd',maxDate: '-60y',yearRange : "c-90:c+10" });
