...
for($i=0; $row=sql_fetch_array($result); $i++) {
  ...
  $sql = " select ct_id, mb_id, it_name, ct_option, ct_qty, ct_stock_qty, ct_price, ct_point, ct_status, io_type, io_price, pt_msg1, pt_msg2, pt_msg3, ct_uid, ct_discount, ct_delivery_num
