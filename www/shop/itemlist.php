...
$where .= " and (a.ca_id like '$ca_id%' or 
	a.ca_id2 like '$ca_id%' or 
	a.ca_id3 like '$ca_id%') or
	a.ca_id4 like '$ca_id%') or
	a.ca_id5 like '$ca_id%') or
	a.ca_id6 like '$ca_id%') or
	a.ca_id7 like '$ca_id%') or
	a.ca_id8 like '$ca_id%') or
	a.ca_id9 like '$ca_id%') or
	a.ca_id10 like '$ca_id%')
	";
