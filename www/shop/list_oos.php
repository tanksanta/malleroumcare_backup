<?php
// shop/list_oos.php?ca_id=10&sort=custom
...
// 정렬
$list_sort_href = './list_oos.php?ca_id='.$ca_id.$qstr.'&amp;sort=';
...
if ($ca_id_len > 2) {
	$len1 = $ca_id_len - 2;
	$up_href = './list_oos.php?ca_id='.substr($ca_id,0,$len1).$qstr;
}
...
// 스킨
$list_skin_file = $list_skin_path.'/list.oos.skin.php';
