    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="form-group has-feedback">
                ...
                <div class="col-sm-3">
                    <input type="text" name="cm_code" value="" id="cm_code" required <?php if($w) echo 'readonly' ?> class="form-control input-sm">
                </div>
                <div class="desc_txt">
            ...
            <div class="form-group has-feedback">
                ...
                <div class="col-sm-2">
                    <input type="text" name="cm_birth" value="" id="cm_birth" class="birthpicker form-control input-sm">
                </div>
            </div>
            <div class="form-group has-feedback">
            ...
            <div class="form-group has-feedback">
                ...
                <div class="col-sm-2">
                    <input type="text" name="cm_joindate" value="" id="cm_birth" class="datepicker form-control input-sm">
                </div>
            </div>
            <div class="form-group has-feedback">
            ...
            <div class="form-group has-feedback">
                ...
                <div class="col-sm-3">
                    <input type="text" name="cm_hp" value="" id="cm_hp" class="form-control input-sm">
                </div>
            </div>
            <div class="form-group has-feedback">
                <label class="col-sm-2 control-label" for="cm_addr"><b>주소</b></label>
                <div class="col-sm-6">
                    <input type="text" name="cm_addr" value="" id="cm_addr" class="form-control input-sm">
                </div>
            </div>
        </div>
    </div>
