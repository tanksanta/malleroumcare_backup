  ...
  <div class="thk101">
    ...
    <table class="app-table">
      ...
      <tbody>
        <tr>
          ...
          <th scope="col">성명</th>
          <td><?=$applicantNm//등록한 신청인이름 ?></td>
          <th scope="col">생년월일</th>
          <td><?=$applicantBirth//등록한 신청일 생년월일 ?></td>
          <th scope="col">수급자와의<br>관계</th>
          <td><?=$applicantRelation//02는 공란이라 미출력 ?></td>
        </tr>
        <tr>
          <th scope="col">주소</th>
            <td colspan="5"><?=$applicantAddr?></td>
        </tr>
        <tr>
          <th scope="col">전화번호</th>
          <td colspan="5" style="position: relative;"><?=$applicantTel//02는 공란이라 미출력 ?><div style="position: absolute; bottom: 0; right: 0; padding: 2px 4px;">(휴대전화: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; )</div></td>
        </tr>
      </tbody>
    </table>
    <table class="app-table">
    ...
    <table class="sign-table">
      ...
      <tbody>
        ...
        <tr>
          <td colspan="2">&nbsp;</td>
          <td colspan="2" class="center" style="font-size: 16px;"><?=date('Y년 m월 d일', strtotime($eform['applicantDate']))?></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
