  ...
  <div class="thk002">
    ...
    <table class="sign_table">
      ...
      <tr>
        ...
        <td class="seal-form" data-id="seal_002_1" style="border-left: 0;color: #999;font-size: 14px;text-align: right"><div style="position: relative; z-index: 100;">( 서명 또는 인 )</div></td>
      </tr>
      <tr>
