...
if (G5_IS_MOBILE) {
	$body_mode = 'is-mobile';
	//echo '<meta name="viewport" content="width=device-width,initial-scale=1.0,minimum-scale=1,maximum-scale=10">'.PHP_EOL;
...
// echo '<script src="' . THEMA_URL . '/assets/js/hammer.min.js" type="text/javascript" charset="utf-8"></script>';
...
<script src="<?php echo G5_JS_URL ?>/common.js?ver=<?php echo APMS_SVER; ?>2"></script>
