...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
	<div style="border:1px solid #dedede">
		...
		<p style="margin:0;padding:30px 30px 30px;border-bottom:1px solid #eee;line-height:1.7em">
			<span style="display:inline-block;width:150px">회원아이디</span> <?php echo $mb['mb_id'];?><br>
			<span style="display:inline-block;width:150px">변경될 비밀번호</span> <strong style="color:#ff3061"><?php echo $change_password;?></strong>
		</p>
