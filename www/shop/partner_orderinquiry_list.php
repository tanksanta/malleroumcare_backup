...
<section class="wrap">
    ...
    <form method="get" class="clear">
        <div class="search_box">
            ...
            <label><input type="checkbox" name="ct_status[]" value="출고준비"
                    <?=option_array_checked('출고준비', $ct_status)?> /> 출고준비</label>
            ...
            <label><input type="checkbox" name="ct_status[]" value="취소" <?=option_array_checked('취소', $ct_status)?> />
                주문취소</label>
            <label><input type="checkbox" name="ct_status[]" value="주문무효"
                    <?=option_array_checked('주문무효', $ct_status)?> /> 주문무효</label>
            <br>
            작업상태 :
            ...
            <div class="search_date">
                ...
                <input type="text" name="fr_date" value="<?=$fr_date?>" id="fr_date" class="datepicker" /> ~ <input
                    type="text" name="to_date" value="<?=$to_date?>" id="to_date" class="datepicker" />
        ...
        <form id="form_ct_status">
            ...
            ?>
                  ...
                  ?>
                                    ...
                                    <p
                                        style="width: 80%; overflow:hidden; text-overflow:ellipsis; white-space:nowrap;margin-top: 3px;">
                ...
                ?>">
                                ...
                                <td class="td_operation">
                                    <a href="partner_orderinquiry_excel.php?od_id=<?=$row['od_id']?>"
                                        class="btn_instructor">작업지시서 다운로드</a>
                ...
                ?>
                                    <a href="javascript:void(0);"
                                        class="btn_delivery_barcode_info <?php echo $disabled_class ?>"
                                        data-id="<?=$row['ct_id']?>" data-od-id="<?=$row['od_id']?>"
                                        data-option="<?=$row['ct_option']?>"
                                        data-cancel="<?php echo in_array($row['ct_status'], ['주문취소', '주문무효']); ?>">
                                        <div>
                                            배송정보
                                        ...
                                        <div style="padding-top: 5px;">
                                            <img src="/skin/apms/order/new_basic/image/icon_02.png"
