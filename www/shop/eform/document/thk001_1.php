<div class="a4">
  <div class="thk001">
    ...
    <table class="thk001_table">
      ...
      <tr>
        <th class="bold" rowspan="3">(갑)</th>
        <th colspan="2">수급자</th>
        <td colspan="3">기초1</td>
        <th class="bold" rowspan="3">(을)</th>
        <th>장기요양기관명</th>
        <td>(주)다온테크</td>
      </tr>
      <tr>
        <th colspan="2">장기요양인정번호</th>
        <td colspan="3">L1111111112</td>
        <th>장기요양기관번호</th>
        <td>126-88-01425</td>
      </tr>
      <tr>
        <th colspan="2">인정등급</th>
        <td>3등급</td>
        <th>구분</th>
        <td>기초 0%</td>
        <th>대표자</th>
      ...
      <tr class="divider">
        <th class="bold" colspan="2">대리인</th>
        <td></td>
        <th colspan="2">수급자와의 관계</th>
        <td colspan="2"></td>
        <th>전화번호</th>
        <td></td>
      </tr>
    ...
    <table class="thk001_table item_table">
      ...
      <tr>
        ...
        <th rowspan="2">개수</th>
        <th rowspan="2">판매계약일</th>
        <th rowspan="2">급여가</th>
        <th rowspan="2">본인부담금</th>
      </tr>
      <tr>
        <th>품목코드</th>
        <th>바코드</th>
