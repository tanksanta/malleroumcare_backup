...
$mb_nick        = trim($_POST['mb_nick'])           ? trim($_POST['mb_nick'])        : trim($_POST['mb_id']);
...
$mb_fax         = isset($_POST['mb_fax'])           ? trim($_POST['mb_fax'])         : "";
...
$mb_type        = THEMA_KEY                         ? trim(THEMA_KEY)               : "";
...
if ($w == '' || $w == 'u') {
    ...
    //if ($msg = exist_mb_nick($mb_nick, $mb_id))     alert($msg, "", true, true); 닉네임 중복체크해지
