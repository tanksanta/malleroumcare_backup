...
$name = $iq['mb_id'] ? get_sideview($iq['mb_id'], get_text($iq['iq_name']), $iq['mb_email'], $iq['mb_homepage']) : '비회원';
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        <th scope="row">이름</th>
        <td><?php echo $name; ?> <?php if($iq['mb_id']) { ?> <a href="/adm/member_form.php?w=u&mb_id=<?php echo get_text($iq['mb_id']) ?>" target="_blank" class="mb_link">보기</a><?php } ?></td>
    </tr>
    <?php if($iq['iq_email']) { ?>
    <tr>
        <th scope="row">이메일</th>
