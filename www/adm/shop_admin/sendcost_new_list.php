...
$sql_common = " from g5_shop_sendcost_new ";
...
<section id="scp_list">
    ...
    <form name="fsendcost" id="fsendcost" method="post" action="./sendcost_new_update.php" onsubmit="return fsendcost_submit(this);">
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr class="<?php echo $bg; ?>">
            ...
            <td class="td_left"><?php echo $row['sc_address']; ?></td>
...
<section id="sendcost_postal">
    ...
    <form name="fsendcost2" method="post" id="fsendcost2" action="./sendcost_new_update.php" autocomplete="off">
    <input type="hidden" name="token" value="">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <tbody>
        <tr>
            <th scope="row"><label for="sc_address">주소<strong class="sound_only">필수</strong></label></th>
            <td>
                <?php echo help("배송지 주소가 입력하신 주소로 시작하는 경우 추가배송비가 적용됩니다.<br>(ex: '제주특별자치도 서귀포시' 입력 > '제주특별자치도 서귀포시 ~' 로 시작하는 배송지에 추가배송비 적용 "); ?>
                <input type="text" name="sc_address" value="" id="sc_address" class="required frm_input" style="width: 100%" required>
            </td>
        </tr>
        <tr>
