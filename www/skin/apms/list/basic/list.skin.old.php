...
for ($i=0; $i < $list_cnt; $i++) {
    ...
    if ($list[$i]['it_name']) {
		$supInfo = "";
		if($list[$i]["prodSupYn"] == "N"){
			$supInfo = "<b style='position: relative; display: inline-block; width: 50px; height: 20px; line-height: 20px; top: -1px; border-radius: 5px; text-align: center; color: #FFF; font-size: 11px; background-color: #DC3333; margin-left: 10px;'>비유통</b>";
		}
