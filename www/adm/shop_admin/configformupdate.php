...
$sql = " update {$g5['g5_shop_default_table']}
            set de_admin_company_owner        = '{$de_admin_company_owner}',
                ...
                de_it_type2_color              = '{$it_type2_color}',
                de_it_type3_name              = '{$it_type3_name}',
                de_it_type3_color              = '{$it_type3_color}',
                de_it_type4_name              = '{$it_type4_name}',
                de_it_type4_color              = '{$it_type4_color}',
                de_it_type5_name              = '{$it_type5_name}',
                de_it_type5_color              = '{$it_type5_color}',
                de_it_type6_name              = '{$it_type6_name}',
                de_it_type6_color              = '{$it_type6_color}',
                de_it_type7_name              = '{$it_type7_name}',
                de_it_type7_color              = '{$it_type7_color}',
                de_it_type8_name              = '{$it_type8_name}',
                de_it_type8_color              = '{$it_type8_color}',
                de_it_type9_name              = '{$it_type9_name}',
                de_it_type9_color              = '{$it_type9_color}',
                de_it_type10_name              = '{$it_type10_name}',
                de_it_type10_color              = '{$it_type10_color}',
                de_it_type11_name              = '{$it_type11_name}',
                de_it_type11_color              = '{$it_type11_color}',
				de_it_type12_name              = '{$it_type12_name}',
                de_it_type12_color              = '{$it_type12_color}',
				de_it_type13_name              = '{$it_type13_name}',
                de_it_type13_color              = '{$it_type13_color}',
                de_item_qa_level              = '{$de_item_qa_level}',
                de_delivery_type_delivery1                  = '{$de_delivery_type_delivery1}',
                de_delivery_type_delivery2                  = '{$de_delivery_type_delivery2}',
                de_delivery_type_quick1                     = '{$de_delivery_type_quick1}',
                de_delivery_type_quick2                     = '{$de_delivery_type_quick2}',
                de_delivery_type_store                      = '{$de_delivery_type_store}',
                de_delivery_type_autobike1                  = '{$de_delivery_type_autobike1}',
                de_delivery_type_autobike2                  = '{$de_delivery_type_autobike2}',
                de_delivery_type_damas1                     = '{$de_delivery_type_damas1}',
                de_delivery_type_damas2                     = '{$de_delivery_type_damas2}',
                de_delivery_type_huamul1                    = '{$de_delivery_type_huamul1}',
                de_delivery_type_huamul2                    = '{$de_delivery_type_huamul2}',
                de_delivery_type_gdhuamul1                  = '{$de_delivery_type_gdhuamul1}',
                de_delivery_type_gdhuamul2                  = '{$de_delivery_type_gdhuamul2}',
