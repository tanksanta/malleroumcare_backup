...
CREATE TABLE IF NOT EXISTS `stock_data_upload` (
  ...
  `sd_it_code` varchar(100) NOT NULL default '' COMMENT '제품코드',
  `sd_it_barcode` varchar(100) NOT NULL default '' COMMENT '바코드값',
  `sd_contract_date` date NOT NULL default '0000-00-00' COMMENT '계약일',
  `sd_sale_date` date NOT NULL default '0000-00-00' COMMENT '판매일자/대여시작기간',
  `sd_rent_date` date NOT NULL default '0000-00-00' COMMENT '대여종료기간',
