...
<div style="margin:30px auto;width:600px;border:10px solid #f7f7f7">
    <div style="border:1px solid #dedede">
        ...
        <a href="<?php echo G5_URL ?>" target="_blank" style="<?php echo $ft_a_st; ?>">사이트방문</a>
        <!-- <a href="<?php echo G5_ADMIN_URL.'/shop_admin/orderform.php?od_id='.$od_id; ?>" target="_blank" style="<?php echo $ft_a_st; ?>">쇼핑몰방문</a> -->
