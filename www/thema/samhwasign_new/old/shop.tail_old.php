...
?>
	...
	<div class="footer_area">
		...
		<div class="info">
			<p class="link">
				<a href="<?php echo G5_BBS_URL;?>/page.php?hid=intro">회사소개 </a>   |   <a href="<?php echo G5_BBS_URL;?>/page.php?hid=provision">이용약관</a>    |   <a href="<?php echo G5_BBS_URL;?>/page.php?hid=privacy"><strong>개인정보취급방침</strong></a>    |   <a href="<?php echo G5_BBS_URL;?>/page.php?hid=noemail">이메일 무단수집거부</a>    |   <a href="<?php echo $at_href['secret'];?>">고객센터</a>
			</p>
			<p>
