...
<div style="padding-bottom:30px;border-bottom:1px solid #cfcfcf;">
    <div style="color:#333333;position:relative;width:70%;float:left;">
        <p style="font-size:42px;padding:0;margin:0;"><b style="font-size:52px;">거래처이름  안현수님</b><br/>주문이 접수되었습니다.</p>
        <p>이로움을 이용해주셔서 감사합니다.</p>
    </div>
    <div style="width:30%;float:right;" >
        <img src="http://signstand.doto.li/img/logo_big.png" style="width:100%;" />
    </div>
        ...
        <tbody>
            ...
            <tr>
                <td style="text-align:left;color:#656565;font-size:13px;height:50px;background-color:#ffffff;padding-left:20px;">
                    <a href="http://signstand.doto.li/shop/item.php?it_id=1597744163" style="text-decoration:none;color:#656565;">
                        <img src="http://signstand.doto.li/shop/img/no_image.gif" width="50" height="50" alt=""> <span style="line-height: 50px;vertical-align: top;">@@테스트 상품@@</span>
                        <p style="margin-left:50px;">@@테스트 상품@@</p>
                    </a>
                </td>
...
<div style="margin-top:50px;border-bottom:1px solid #cfcfcf;padding-bottom:20px;text-align: center;">
    ...
    <div style="text-align: left;width: 80%;margin: 20px auto;">
        <img src="http://signstand.doto.li/img/icon_file.png" style="float:left;display:block;" />
        <div style="float:left;margin-left:10px;">
            <span style="line-height:30px;font-size:13px;">첨부파일</span>
            <ul style="list-style:none;margin:0;padding:0;"><li style="list-style:none;margin:0;padding:0;margin-bottom:10px;"><a href="http://signstand.doto.li/data/order_cart/2020081819295429_삼화쇼핑몰New_admin_order_view_print_작업지시서.png" style="text-decoration: underline;color: #0592ff;font-size:12px;">삼화쇼핑몰New_admin_order_view_print_작업지시서.png</a></li>
            </ul>
        </div>
        <div style="clear:both;"></div>
    </div>
...
<p style="font-size:12px;color:#656565;margin:30px auto;text-align:center;">
    대표자: 김영재 | 사업자등록번호: 358-85-01550 | 통신판매신고번호: 2020-고양일산동-1659 <br/>
    개인정보보호관리자: 유성균 | 주소: 경기도 고양시 일산동구 공릉천로 301-1
    <br/><br/>
    Copyright © 삼화에스앤디(주)고양지점 All rights reserved.
</p>
</div>
