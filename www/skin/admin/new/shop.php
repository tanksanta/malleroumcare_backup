    ...
    <div id="sidx_stat">
        ...
        <section id="anc_sidx_stock">
            ...
            <div id="sidx_stock" class="tbl_head01 tbl_wrap">
                ...
                <tbody>
                <tr>
                    <td class="td_numbig"><a href="<?php echo G5_ADMIN_URL;?>/shop_admin/itemstocklist.php"><?php echo number_format($item_noti); ?></a></td>
                    <td class="td_numbig"><a href="<?php echo G5_ADMIN_URL;?>/shop_admin/optionstocklist.php"><?php echo number_format($option_noti); ?></a></td>
