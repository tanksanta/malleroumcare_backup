...
?>
	...
	<div class="footer_area">
		...
		<div class="info">
			<p class="link">
				<a href="<?php echo G5_BBS_URL;?>/page.php?hid=intro">회사소개 </a>   |   <a href="<?php echo G5_BBS_URL;?>/content.php?co_id=provision">이용약관</a>    |   <a href="<?php echo G5_BBS_URL;?>/content.php?co_id=privacy"><strong>개인정보 처리방침</strong></a>    |   <a href="<?php echo G5_BBS_URL;?>/page.php?hid=noemail">이메일 무단수집거부</a>    |   <a href="/shop/orderinquiry.php">주문조회(비회원)</a>
			</p>
			<p>
