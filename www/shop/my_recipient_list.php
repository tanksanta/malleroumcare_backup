...
<div id="myRecipientListWrap">
  <div class="titleWrap" style="margin-bottom:10px;">
    ...
    <div class="page_rows">
        ...
        <select name="page_rows" id="page_rows" style="font-weight: normal;" onChange="loading_onoff('on')">
      ...
      <table >
          ...
          <th>
              <p class="con_top">적용구간 종료 30일 이내</p>
      		  <p class="con_mid"><a href="my_recipient_list.php?option=expire" onclick="loading_onoff('on')"><?php echo $count_on_deadline ?>명</a></p>
          ...
          <th>
              ...
              <p class="con_mid"><a href="my_recipient_list.php?option=rental" onclick="loading_onoff('on')"><?php echo count($arr_rental)?>명</a></p>
...
-->
  ...
  <div class="list-paging"; >
    <ul class="pagination pagination-sm en" onclick="loading_onoff('on')">
      <?php 
      if($page_option == 'none'){
