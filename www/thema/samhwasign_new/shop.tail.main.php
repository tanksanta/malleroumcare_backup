...
<?php } ?>
<script>
    var tabCarousel = null;
    function setTabInterval() {
        if( tabCarousel ) clearInterval(tabCarousel)
	...
	$(function() {
        setTabInterval()
        $("#top-menu-container").hover(function() {
...
<!-- Smartlog -->
<script type="text/javascript"> 
    var hpt_info={'_account': '<?php echo DAUM_HPT_INFO_ACCOUNT; ?>'};
</script>
<script language="javascript" src="//a16.smlog.co.kr/smart.js" charset="utf-8"></script>
<noscript><img src="//a16.smlog.co.kr/smart_bda.php?_account=7229" style="display:none;width:0;height:0;" border="0"/></noscript> 