...
<div class="table-responsive">
    ...
    <?php for ($i=0; $i < count($list); $i++) { ?>
		<tr<?php echo ($i == 0) ? ' class="tr-line"' : '';?>>
			...
			<td class="text-left"><?php echo $list[$i]['it_model']; ?><br><?php echo $list[$i]['it_name'] ? '(' . $list[$i]['it_name'] . ')' : ''; ?></td>
			<td class="text-center"><?php echo $list[$i]['od_b_name']; ?></td>
			<td class="text-left"><?php echo show_delivery_info($list[$i]); ?></td>
