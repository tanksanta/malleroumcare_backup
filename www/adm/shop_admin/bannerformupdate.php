...
$bn_title = strip_tags(clean_xss_attributes($bn_title));
$bn_content = strip_tags(clean_xss_attributes($bn_content));
$bn_bgcolor = strip_tags(clean_xss_attributes($bn_bgcolor));
