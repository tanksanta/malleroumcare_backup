...
if ($default['de_naverpayorder_test_mb_id'] && $member['mb_id'] == $default['de_naverpayorder_test_mb_id']) { // wetoz : 쇼핑몰설정에서 네이버페이 주문 테스트용 아이디 와 일치할경우 테스트주문으로 처리.
    $default['de_naverpay_test'] = '1';
    $default['de_naverpay_mb_id'] = $default['de_naverpayorder_test_mb_id'];
}
