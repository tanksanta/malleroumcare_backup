<?php
    ...
    // return false;
    $headers = array("상품종류","카테고리","상품관리코드","분류코드","품목코드","상품명","관리자 메모","기본설명","재질","사이즈 상세정보","중량","상품태그","업체 아이디","유통구분","세무정보","공급자아이디","제품코드","제조사","원산지","판매가능","판매가격","급여가","대여금액(월)","대여(사용여부)","대여(판매가능기간)","대여(내구연한 설정 기간)","대여(기간 이후 대여금액)","사업소 판매가격(원)","우수사업소 판매가격(원)","묶음할인 조건1","묶음할인 조건2","묶음할인 조건3","묶음할인 조건4","묶음할인 조건5","파트너몰 판매가격","상품품절","재고수량","재고 통보수량","최소구매수량","최대구매수량","옵션1","옵션1 항목","옵션2","옵션2 항목","옵션3","옵션3 항목","직배송","배송비 상세조건","배송비 유형","산간지역 추가 배송비");
    $data = array_merge(array($headers), $rows);
    
    $widths  = array(30, 30, 30, 30, 30, 30, 30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30,30);
