...
var reg_mb_giup_bnum_check = function() {
    var result = "";
    $.ajax({
        type: "POST",
        url: g5_bbs_url+"/ajax.mb_giup_bnum.php",
        data: {
            "reg_mb_giup_bnum": encodeURIComponent($("#mb_giup_bnum").val())
        },
        cache: false,
        async: false,
        success: function(data) {
...
var reg_mb_giup_sbnum_check = function() {
    var result = "";
    $.ajax({
        type: "POST",
        url: g5_bbs_url+"/ajax.mb_giup_sbnum.php",
        data: {
            "reg_mb_giup_bnum": encodeURIComponent($("#mb_giup_bnum").val()),
            "reg_mb_giup_sbnum": encodeURIComponent($("#mb_giup_sbnum").val())
        },
        cache: false,
        async: false,
        success: function(data) {
