...
if($w === 'w') {
  ...
  $sql = " select sum(ws_qty) as total from warehouse_stock where wh_name = '$wh_name' ";
...
while($row = sql_fetch_array($result)) {
  $sql = " select sum(ws_qty) as total from warehouse_stock where wh_name = '{$row['wh_name']}' ";
  $total = sql_fetch($sql);
