...
sql_query("CREATE TABLE IF NOT EXISTS `partner_inst_sts` (
  ...
  `delivery_date` DATE NOT NULL COMMENT '설치(출고) 날짜',
  `delivery_datetime` CHAR(5) NOT NULL COMMENT '설치(출고) 시간(포맷: HH:MM)',
  ...
  `partner_manager_mb_name` VARCHAR(255) NOT NULL COMMENT '설치 파트너 매니저 이름',
