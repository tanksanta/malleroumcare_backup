  ...
  if (!$od['od_id']) {
    ...
    if ($od["ordId"]) {
      ...
      if ($result) {
        ...
        $od = sql_fetch("SELECT * FROM purchase_order WHERE od_id = '{$od["od_id"]}'");
...
<style>
  * {
  ...
  .titleTable > tbody > tr > *:first-of-type {
    border-left: 1px solid #000;
  }

  .titleTable > tbody > tr > th {
  ...
  .prodsTable tr > *:last-child {
    border-right: 0;
  }

  .prodsTable > thead > tr > th {
    background-color: #F5F5F5;
  }
