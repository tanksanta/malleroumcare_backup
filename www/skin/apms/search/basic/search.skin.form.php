		...
		<div class="search-box" style="padding-bottom:0px;">
			<div class="form-group">
				...
				<div class="col-sm-9 item-sfl">
					...
					<label class="checkbox-inline" style="min-width:55px;"><input type="checkbox" name="pttag" id="ssch_pttag" value="1" <?php echo $pttag_check?'checked="checked"':'';?>> 태그</label>
					<label class="checkbox-inline"><input type="checkbox" name="itmaker" id="ssch_itmaker" value="1" <?php echo $itmaker_check?'checked="checked"':'';?>> 제조업체</label>
