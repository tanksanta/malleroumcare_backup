            ...
            <table class="popup_table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="./pop.order.item.matching.option.php?od_id=<?php echo $od_id; ?>&it_id=<?php echo $row['it_id']; ?>&oit_id=<?php echo $it_id; ?>&ct_id=<?php echo $ct_id; ?>" class="shbtn lineblue">선택</a>
                        </td>
                    </tr>
                    <?php
                    }
