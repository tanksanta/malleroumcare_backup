...
<li><a href="#anc_sodr_manager">담당자 지정</a></li>
...
<section id="anc_sodr_manager">
    <h2 class="h2_frm">담당자 지정</h2>
    <?php echo $pg_anchor; ?>

    <div class="tbl_head02 tbl_wrap">

        <form name="frmorderform9" action="./orderformmanagerupdate.php" method="post">
        <input type="hidden" name="od_id" value="<?php echo $od_id; ?>">
        <input type="hidden" name="sort1" value="<?php echo $sort1; ?>">
        <input type="hidden" name="sort2" value="<?php echo $sort2; ?>">
        <input type="hidden" name="sel_field" value="<?php echo $sel_field; ?>">
        ...
        <input type="hidden" name="mod_type" value="info">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <th scope="col" style="width:100px;">영업담당자</th>
                    ...
                    <tr>
                        <th scope="col" style="width:100px;">출고담당자</th>
                        <td style="padding-left:30px;">
    ...
    <div class="compare_wrap">
        ...
        <section id="anc_sodr_chk" class="compare_left">
            ...
            <div class="tbl_frm01">
                ...
                <?php if ($od['od_giup_manager']) {
                    $sql = "SELECT * FROM g5_member_giup_manager WHERE mm_no = '{$od['od_giup_manager']}'";
                    $om_result = sql_fetch($sql);
                ?>
                <tr>
                    <th scope="row">기업회원담당자</th>
                    <td><?php echo $om_result['mm_name']; ?> (<?php echo $om_result['mm_tel']; ?>) 더존코드:<?php echo $om_result['mm_thezone']; ?></td>
                </tr>
                <?php } ?>
                <?php
