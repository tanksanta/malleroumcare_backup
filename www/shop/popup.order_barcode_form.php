                        ...
                        <?php } ?>
                            <ul class="inputbox">
                                <?php for($b = 0; $b< count($barcodes); $b++){ ?>
                                    <li>
										<input type="number" maxlength="12" oninput="maxLengthCheck(this)" value="<?php echo $barcodes[$b]; ?>" class="notall frm_input frm_input_<?=$prodListCnt?> required barcode_input prodBarNumItem_STO<?=$prodListCnt?>" placeholder="바코드를 입력하세요." data-frm-no="<?=$prodListCnt?>" maxlength="12">
