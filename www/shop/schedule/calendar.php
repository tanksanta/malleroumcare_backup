      ...
      <div class="flex flex-column border-t">
                    ...
                    <div style="height: 80px" class="overflow-y-auto">
                      ...
                      <div class="flex-1 flex flex-row" :class="{'hidden': Object.keys(events).filter(e => new Date(e).toDateString() === new Date(year, month, date).toDateString()).length === 0 ? true :
                                                    ...
                                                    (
                                                        ...
                                                        (filter_mb_id !== '' && events[Object.keys(events).filter(e => new Date(e).toDateString() === new Date(year, month, date).toDateString())[0]].filter(e => e.type === 'deny_schedule').filter(e => mb_type === 'default' ? filter_mb_id == <?php if ($member["mb_type"] === "default" && $member["mb_level"] >= 9) echo 'e.partner_mb_id'; else echo 'e.od_b_name'; ?> : e.partner_manager_mb_id === filter_mb_id).length === 0)
                                                    )}">
                      ...
                      <div class="flex-1 flex flex-row" :class="{'hidden': Object.keys(events).filter(e => new Date(e).toDateString() === new Date(year, month, date).toDateString()).length === 0 ? true :
                                                    ...
                                                    (
                                                        ...
                                                        (filter_mb_id !== '' && events[Object.keys(events).filter(e => new Date(e).toDateString() === new Date(year, month, date).toDateString())[0]].filter(e => e.type === 'schedule').filter(e => mb_type === 'default' ? filter_mb_id == <?php if ($member["mb_type"] === "default" && $member["mb_level"] >= 9) echo 'e.partner_mb_id'; else echo 'e.od_b_name'; ?> : e.partner_manager_mb_id === filter_mb_id).length === 0)
                                                    )}">
                        <div class="flex flex-col justify-center w-full max-h-6">
                          <div class="h-4 flex items-center flex-row">
                            ...
                            <span class="ml-1 text-xs line-clamp-1" x-text="filter_mb_id == '' ?
                                                            ...
                                                            '' :
                                                            Object.keys(events).filter(e => new Date(e).toDateString() === new Date(year, month, date).toDateString()).length !== 0 ?
                                                            events[Object.keys(events).filter(e => new Date(e).toDateString() === new Date(year, month, date).toDateString())[0]].filter(e => e.type === 'schedule').length > 1 && events[Object.keys(events).filter(e => new Date(e).toDateString() === new Date(year, month, date).toDateString())[0]].filter(e => e.type === 'schedule').filter(e => mb_type === 'default' ? filter_mb_id == <?php if ($member["mb_type"] === "default" && $member["mb_level"] >= 9) echo 'e.partner_mb_id'; else echo 'e.od_b_name'; ?> : e.partner_manager_mb_id === filter_mb_id).length > 1 ?
                                                            events[Object.keys(events).filter(e => new Date(e).toDateString() === new Date(year, month, date).toDateString())[0]].filter(e => e.type === 'schedule').filter(e => mb_type === 'default' ? filter_mb_id == <?php if ($member["mb_type"] === "default" && $member["mb_level"] >= 9) echo 'e.partner_mb_id'; else echo 'e.od_b_name'; ?> : e.partner_manager_mb_id === filter_mb_id)[0]?.it_name.slice(0, 6) + '... 외 ' + (events[Object.keys(events).filter(e => new Date(e).toDateString() === new Date(year, month, date).toDateString())[0]].filter(e => e.type === 'schedule').filter(e => e.type === 'schedule').filter(e => mb_type === 'default' ? filter_mb_id == <?php if ($member["mb_type"] === "default" && $member["mb_level"] >= 9) echo 'e.partner_mb_id'; else echo 'e.od_b_name'; ?> : e.partner_manager_mb_id === filter_mb_id).length - 1) + '건' :
                                                            events[Object.keys(events).filter(e => new Date(e).toDateString() === new Date(year, month, date).toDateString())[0]].filter(e => e.type === 'schedule').filter(e => mb_type === 'default' ? filter_mb_id == <?php if ($member["mb_type"] === "default" && $member["mb_level"] >= 9) echo 'e.partner_mb_id'; else echo 'e.od_b_name'; ?> : e.partner_manager_mb_id === filter_mb_id)[0]?.it_name.slice(0, 6) + '...' :
                                                            ''"></span>
                          </div>
                        </div>
                      </div>
                      <!-- 설치 완료 건수 -->
                      <div class="flex-1 flex flex-row" :class="{'hidden': Object.keys(events).filter(e => new Date(e).toDateString() === new Date(year, month, date).toDateString()).length === 0 ? true :
                                                    events[Object.keys(events).filter(e => new Date(e).toDateString() === new Date(year, month, date).toDateString())[0]].filter(e => e.type === 'schedule' && e.status === '완료').length === 0 ? true :
                                                    (
                                                        (filter_mb_id !== '' && events[Object.keys(events).filter(e => new Date(e).toDateString() === new Date(year, month, date).toDateString())[0]].filter(e => e.type === 'schedule' && e.status === '완료').length === 0) ||
                                                        (filter_mb_id !== '' && events[Object.keys(events).filter(e => new Date(e).toDateString() === new Date(year, month, date).toDateString())[0]].filter(e => e.type === 'schedule' && e.status === '완료').filter(e => mb_type === 'default' ? filter_mb_id == <?php if ($member["mb_type"] === "default" && $member["mb_level"] >= 9) echo 'e.partner_mb_id'; else echo 'e.od_b_name'; ?> : e.partner_manager_mb_id === filter_mb_id).length === 0)
                                                    )}">
                        <div class="flex flex-col justify-center w-full max-h-6">
                          <div class="h-4 flex items-center flex-row">
                            ...
                            <span class="ml-1 text-xs" x-text="filter_mb_id == '' ?
                                                            ...
                                                            '' :
                                                            Object.keys(events).filter(e => new Date(e).toDateString() === new Date(year, month, date).toDateString()).length !== 0 ?
                                                            '설치완료 ' + (events[Object.keys(events).filter(e => new Date(e).toDateString() === new Date(year, month, date).toDateString())[0]].filter(e => e.type === 'schedule' && e.status === '완료').filter(e => e.type === 'schedule' && e.status === '완료').filter(e => mb_type === 'default' ? filter_mb_id == <?php if ($member["mb_type"] === "default" && $member["mb_level"] >= 9) echo 'e.partner_mb_id'; else echo 'e.od_b_name'; ?> : e.partner_manager_mb_id === filter_mb_id).length) + '건' :
                                                            ''"></span>
                          </div>
                        </div>
                      </div>
        ...
        <section class="basis-80 bg-white border-l flex flex-col h-172">
          ...
          <ul class="flex-1 overflow-y-auto" id="table">
            <template
                x-for="(item, index) in filter_mb_id == '' ? schedules.filter(e => e.type == 'deny_schedule') : schedules.filter(e => e.type == 'deny_schedule').filter(e => mb_type === 'default' ? filter_mb_id == <?php if ($member["mb_type"] === "default" && $member["mb_level"] >= 9) echo 'e.partner_mb_id'; else echo 'e.od_b_name'; ?> : e.partner_manager_mb_id === filter_mb_id)"
                :key="index">
            ...
            <template
                x-for="(item, index) in filter_mb_id == '' ? schedules.filter(e => e.type == 'schedule') : schedules.filter(e => e.type === 'schedule').filter(e => mb_type === 'default' ? filter_mb_id == <?php if ($member["mb_type"] === "default" && $member["mb_level"] >= 9) echo 'e.partner_mb_id'; else echo 'e.od_b_name'; ?> : e.partner_manager_mb_id === filter_mb_id)"
                :key="index">
              <li class="min-h-64 flex flex-col mb-4 px-4">
                <div class="basis-12 flex flex-row align-center">
                  <p class="flex-1 inline-flex items-center text-lg font-bold"
                     x-text="(item.status === '완료') ? '설치완료' : (item.status === '배송') ? '배송' : '설치예정 : ' + item.delivery_datetime"/>
                  <div class="basis-30 flex items-center justify-start">
                    <button type="button"
                      ...
                      echo ":class=\"{ 'bg-gray-100': item.status === '준비', 'hover:bg-gray-100': item.status === '준비', 'cursor-not-allowed':item.status === '준비' }\"";
                      echo "x-bind:disabled=\"item.status === '준비'\"";
                ...
                <div class="flex-1 flex flex-col border">
                  ...
                  <div class="flex-1 flex flex-row border-b"
                    ...
                    <div class="basis-24 min-w-24 flex pl-2 justify-start items-center border-r bg-gray-100">
                      <span class="font-bold"
                            x-text="'<?php if (($member["mb_level"] < 9 && $member["mb_type"] === 'default') || $member["mb_type"] === 'partner') echo '담당자연락처'; else echo '업체연락처'; ?>'"/>
                    </div>
                    <div class="flex-1 flex items-center px-4 py-2">
                      <span x-text="item.partner_manager_hp ? item.partner_manager_hp : '없음'"/>
                    </div>
                  </div>
                  <div class="flex-1 flex flex-row border-b">
                    <div class="basis-24 min-w-24 flex pl-2 justify-start items-center border-r bg-gray-100">
                  ...
                  <div class="flex-1 flex flex-row border-b">
                    ...
                    <div class="flex-1 flex items-center px-4 py-2">
                      <span x-text="item.od_b_hp ? item.od_b_hp : '없음'"/>
                    </div>
                  </div>
                  <div class="flex-1 flex flex-row border-b">
                    <div class="basis-24 min-w-24 flex pl-2 justify-start items-center border-r bg-gray-100">
