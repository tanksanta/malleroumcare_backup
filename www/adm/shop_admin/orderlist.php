...
if( !in_array($sel_field, array('od_id', 'mb_id', 'od_name', 'od_tel', 'od_hp', 'od_b_name', 'od_b_tel', 'od_b_hp', 'od_deposit_name', 'od_invoice', 'od_naver_orderid')) ){   //검색할 필드 대상이 아니면 값을 제거
    $sel_field = '';
}
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="orderlist<?php echo ' '.$bg; ?>">
        ...
        <td rowspan="3" class="td_mng td_mng_s">
			...
			<?php } else { ?>
                <a href="./orderformnaverapi.php?od_id=<?php echo $row['od_id']; ?>&amp;<?php echo $qstr; ?>" class="mng_mod btn btn_02"><span class="sound_only"><?php echo $row['od_id']; ?> </span>보기</a>
            <?php } // wetoz : naverpayorder ?>
        </td>
    </tr>
