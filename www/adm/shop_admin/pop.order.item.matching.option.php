...
$sql = "SELECT count(*) as cnt FROM `g5_shop_item_option` WHERE it_id = '{$it_id}' ";
...
$dealer_price = false;
if ( $w ) {
    $sql = " select * from {$g5['g5_shop_cart_table']} where od_id = '$od_id' and it_id = '$it_id' and ct_id = '$ct_id' order by io_type asc, ct_id asc ";
...
<div id="pop_add_item" class="admin_popup">
    ...
    <div class="content">
        <form name="foption" class="form" role="form" method="post" action="./pop.order.item.matching.option_result.php" onsubmit="return formcheck(this);">
            <div class="item_options">
                ...
                <div id="mod_option_form">
                        ...
                        <input type="hidden" name="oit_id" value="<?php echo $oit_id; ?>">
                        ...
                        <input type="hidden" id="it_price" value="<?php echo $it['it_price']; ?>">
                        ...
                        <table id="add_item_options_table">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="chk_dealer_price_div">
                                            <input type="checkbox" name="chk_partner_price" value="1" id="chk_partner_price" onclick="price_calculate();">
                                            사용
                                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="chk_dealer_price_div">
                                            <input type="checkbox" name="chk_dealer_price" value="1" id="chk_dealer_price" onclick="price_calculate();">
                                            사용
                                        </div>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <textarea name="g5_shop_order_cart_memo" rows="8" placeholder="메모를 입력하세요." id="g5_shop_order_cart_memo"><?php echo $memo['ctm_memo']; ?></textarea>
                                    </td>
                                </tr>
								<tr>
								 <td>
								   이상품 다음에도 매칭적용 <input type="checkbox" name="chk_maching_data" value="1" id="chk_maching_data">
								 </td>
								</tr>
                           </tbody>
                        </table>
                                    ...
                                    <table class="cs_table">
                                        <tbody>
                                            <tr>
                                                <th>사이즈</th>
                                                <td>
                                                    <label for="size_width">가로</label><input type="text" name="size_width" id="size_width" value="<?php echo $cs['size_width']; ?>" /> mm
                                                    <span class="lrmg15">X</span>
                                                    <label for="size_height">세로</label><input type="text" name="size_height" id="size_height" value="<?php echo $cs['size_height']; ?>" /> mm
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="radio" name="frame_standard" id="frame_standard_3" value="보이는면" <?php echo $cs['frame_standard'] == '보이는면' ? 'checked' : ''; ?> /><label for="frame_standard_3">보이는면</label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>색상</th>
                                    ...
                                    <table class="cs_table">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <select id="lightpanel_led_k" name="lightpanel_led_k" class="">
                                                        <?php for($i=1000;$i<=20000;$i=$i+1000) { ?>
                                                            <option value="<?php echo $i; ?>" <?php echo $cs['lightpanel_led_k'] == $i ? 'selected' : ''; ?>><?php echo $i; ?>K</option>
                                                        <?php } ?>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>전원선</th>
                                                <td>
                                                    <label for="lightpanel_power_line_dc">DC잭</label><input type="text" name="lightpanel_power_line_dc" id="lightpanel_power_line_dc" value="<?php echo $cs['lightpanel_power_line_dc']; ?>"  />m
                                                    <span class="lrmg15">/</span>
                                                    <label for="lightpanel_power_line_wire">와이어</label><input type="text" name="lightpanel_power_line_wire" id="lightpanel_power_line_wire"  value="<?php echo $cs['lightpanel_power_line_wire']; ?>" />m
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>레이저가공</th>
                                    ...
                                    <table class="cs_table">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>파이프 간격</th>
                                                <td>
                                                    <label for="holder_pipe_interval_1" class="hidden"></label><input type="text" name="holder_pipe_interval_1" id="holder_pipe_interval_1" value="<?php echo $cs['holder_pipe_interval_1']; ?>" />m&nbsp;&nbsp;&nbsp;↔
                                                    <label for="holder_pipe_interval_2" class="hidden"></label><input type="text" name="holder_pipe_interval_2" id="holder_pipe_interval_2" value="<?php echo $cs['holder_pipe_interval_2']; ?>" />m&nbsp;&nbsp;&nbsp;↔
                                                    <label for="holder_pipe_interval_3" class="hidden"></label><input type="text" name="holder_pipe_interval_3" id="holder_pipe_interval_3" value="<?php echo $cs['holder_pipe_interval_3']; ?>" />m
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>길이</th>
                                                <td>
                                                    <label for="holder_pipe_length" class="hidden"></label><input type="text" name="holder_pipe_length" id="holder_pipe_length" value="<?php echo $cs['holder_pipe_length']; ?>" />m
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
