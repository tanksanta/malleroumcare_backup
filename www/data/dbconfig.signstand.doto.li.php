...
define('G5_MYSQL_HOST', '175.126.176.11');
define('G5_MYSQL_USER', 'beautyfoodlife');
define('G5_MYSQL_PASSWORD', 'beautyfoodlife!@#!@#999#gaksdjfklasdjf');
define('G5_MYSQL_DB', 'life');
...
// 네이버 코드
define('NAVER_WCS_WA', 's_4372b22f12c2');

// 다음코드
define('DAUM_HPT_INFO_ACCOUNT', 'UHPT-7229');
define('DAUM_CONVERSION_ACCOUNT_ID', 'fslJWyOe49ihVk4xLM3e3Q00');
?>